...
%     eta     
    ...
    [S_tau_all, risk_tau_all] = arrayfun(@risk_analysis_simulateMC, eps_t_all_1, eps_t_all_2, xt(1), xt(2), f_xt(1), f_xt(2), t0, h, T, b, s, xR, xS, yR, yS, xP, xQ, yP, yQ, eta, k, c, d, Delta); %an array that stores S(tau) and risk(tau) of each sample path starting at time t and state xt
