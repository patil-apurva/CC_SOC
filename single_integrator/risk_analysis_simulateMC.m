function [S_tau_all, risk_tau_all] = risk_analysis_simulateMC(eps_t_all_1, eps_t_all_2, xt_prime_1, xt_prime_2, f_xt_prime_1, f_xt_prime_2, t0, h, T, b, s, xR, xS, yR, yS, xP, xQ, yP, yQ, eta, k, c, d, Delta)

    eps_t_prime_1 = eps_t_all_1; %standard normal noise at t
    eps_t_prime_2 = eps_t_all_2; %standard normal noise at t
    
    S_tau = 0; %the cost-to-go of the state dependent cost of a sample path tau
