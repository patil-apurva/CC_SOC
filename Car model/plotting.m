...
eta_star_PI = [1.218, 1.06, 0.9970, 0.9580, 0.905, 0.888, 0.832, 0.7760];

pfail_PI = [0.2, 0.3, 0.38, 0.48, 0.59, 0.63, 0.78, 0.88];
...
plot(Delta, time, 'b-o', 'LineWidth',3.5, 'MarkerSize',20)