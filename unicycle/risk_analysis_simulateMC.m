function [S_tau_all, risk_tau_all] = risk_analysis_simulateMC(eps_t_all_1, eps_t_all_2, xt_prime_1, xt_prime_2, xt_prime_3, xt_prime_4, f_xt_prime_1, f_xt_prime_2, f_xt_prime_3, f_xt_prime_4, h, T, b, s, xR1, xS1, yR1, yS1, xR2, xS2, yR2, yS2, xP, xQ, yP, yQ, eta, d, k1, k2, k3, Delta)
    ...
    for t_prime = 0:h:T-h % this loop is to compute S(tau_i) and risk(tau_i)
