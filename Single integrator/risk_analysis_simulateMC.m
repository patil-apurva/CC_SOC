function [S_tau_all, risk_all] = risk_analysis_simulateMC(eps_t_all_1, eps_t_all_2, xt_prime_1, xt_prime_2, f_xt_prime_1, f_xt_prime_2, t, h, T, b, s, xR, xS, yR, yS, xP, xQ, yP, yQ, eta, k, c, d)
